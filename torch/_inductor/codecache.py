    ...
    def load_with_key(
        ...
        if compiled_graph is not None:
            ...
            if remote_cache:
                ...
                get_metrics_context().add_to_set("inductor_fx_remote_cache_hit_keys", key)
            ...
            if remote_cache:
                ...
                get_metrics_context().increment("inductor_fx_remote_cache_miss_count", 1)
                get_metrics_context().add_to_set("inductor_fx_remote_cache_miss_keys", key)
